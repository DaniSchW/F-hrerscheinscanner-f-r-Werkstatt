  ...
  return [
    ...
    'input_schema' => [
      ...
      'properties' => [
        ...
        'adresse' => ['type' => ['string', 'null'], 'description' => 'Straße und Hausnummer, nur falls auf dem Führerschein vermerkt'],
        'plz' => ['type' => ['string', 'null'], 'description' => 'Postleitzahl, nur falls auf dem Führerschein vermerkt'],
        'ort' => ['type' => ['string', 'null'], 'description' => 'Wohnort, nur falls auf dem Führerschein vermerkt'],
      ...
      'required' => [
        'vorname', 'nachname', 'geburtsdatum', 'geburtsort', 'adresse', 'plz', 'ort',
